...
const Shipping = () => {
    ...
    console.log("GetShipmentDetailsData",GetShipmentDetailsData)
    ...
    const ConfirmDeleverFun = (e) => {
        ...
        console.log("checking payload.........", payloadShipping)
    ...
    useEffect(() => {
        console.log("check pincodddeeeee------", PostPincodesAvailabilityReducer)
    ...
    useEffect(() => {
        ...
        console.log("addresss===========", pickuppatchfilterdata)
    ...
    const handlePaymentSuccess = async (response, orderId) => {
        ...
        // console.log("responecget", orderId)
        ...
        console.log("sdsd", InvoicePayLoad)
                                ...
                                <div className={`${deliverypincodeactive && pickuppincodeactive ? " " : "disable_opercity"} `}>
                                    ...
                                    <form className='row' >
                                        ...
                                        <div className='form-box col-12 mb-3'>
                                            ...
                                            <input
                                                className="form-control" placeholder="Product Price" type="number" id="price-text"

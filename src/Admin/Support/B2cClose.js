...
function B2cClose() {
  ...
  const GetSettingViewB2cCloseFeedbackData = useSelector(
    (state) =>
      state.GetSettingViewB2cCloseFeedbackReducer
        .GetSettingViewB2cCloseFeedbackData?.data
  );
            ...
            <div className="sptitle">
              <div className="select-box">
                ...
                >
                 ...
                 { PermissionData()?.VIEW_SUPPORT_B2C_PAGE == "VIEW_SUPPORT_B2C_PAGE"?<option value="new" className="px-3">
                    New Tickets
                  </option>:""}
                </select>
              </div>

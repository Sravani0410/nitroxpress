...
import { PostOrderTrack } from "../Redux/action/ApiCollection";
...
const Ordertrack = () => {
  ...
  const [ViewMoreToggleId, setViewMoreToggleId] = useState(null);

  const ToggleFunData = useSelector(
    (state) => state.ToggleSideBarReducer.ToggleSideBarData
  );
  const GetAdminOrderSummuryData = useSelector(
          ...
          <div className="orderinfo-header">
            ...
            <div className="orderinfobtn-group">
              <button
                ...
                onClick={(e) => {
                  paramHash.hash == "#dashboard"
                    ? navigate(`/admin/dashboard#/`)
                    : navigate(
                        `/admin/Orderinner/${param.id}${paramHash.hash}`
                      );
                ...
                {/* {PostOrderTrackData?.data?.track_details.map((item, id) => {
                  return (
                    ...
                    >
                      ...
                      {returnreasonvalue &&
                      returnreasonvalue[returnreasonvalue?.length - 1]
                        ?.reason ? (
                        <label>Reason</label>
                      ) : (
                        ""
                      ...
                      <h4>
                        {" "}
                        {item?.order_status === "RTO" ||
                        item?.order_status === "RTO_DELIVERED"
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <p>
                      {" "}
                      {
                        PostOrderTrackData?.data?.delivered_address
                          ?.delivered_name
                      }{" "}
                    </p>
                  </li>
                  ...
                  <li>
                    <h4>Street Name</h4>
                    <p>{`${PostOrderTrackData?.data?.delivered_address?.delivered_city}, ${PostOrderTrackData?.data?.delivered_address?.delivered_state}`}</p>
                  </li>
                  <li>
                    <h4>Postcode</h4>
                    <p>

...
import { GetDeliveryPriceDetail, PostViewAdminOrder, GetAdminOrderPaymentOrder, PostAdminOrderPaymentOrder, PostAdminOrderAddShipment } from "../../Redux/action/ApiCollection";
...
const OrderSummary = () => {
  ...
  useEffect(() => {
    console.log("PostAdminOrderAddShipmentData", PostAdminOrderAddShipmentData) 
  ...
  useEffect(() => {
    ...
    let PayloadOrder = reactLocalStorage.get("PayloadOrderData", false);
    let PayloadOrderData = JSON.parse(PayloadOrder)
    console.log("UpdateFromLocalStoragevalues", PayloadUser)
  ...
  useEffect(() => {
    ...
    if (GetAdminOrderPaymentOrderData) {
      console.log("GetAdminOrderPaymentOrderData==>", GetAdminOrderPaymentOrderData)
  ...
  const ProceedToPayFun = () => {
    console.log("ItemDetailPayloadData", ItemDetailPayloadData)

...
const OrderDatails = () => {
  ...
  console.log("shippingprice", ewayPdf.length)
  //   const url =
 ...
 // Don't delete this comment 
  ...
  console.log("nvdcnbd", selectedproduct)
                    ...
                    >
                      <option value="null"   >Select Package Type...</option>
                      {
                        packageShipping?.map((item) => {
                          { console.log("jsdghjgdh", shippingprice) }
                          return (

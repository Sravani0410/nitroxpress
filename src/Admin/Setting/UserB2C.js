        ...
        <div className="content-sec userprofile-sec">
          <div className="title-bar">
            <div className="left-part">
              ...
              >
                {PermissionData()?.VIEW_SETTING_USER_B2C_PAGE ==
                      "VIEW_SETTING_USER_B2C_PAGE"?<option value="b2c">B2C</option>:""}
                {PermissionData()?.VIEW_SETTING_USER_PROFILE_PAGE ==
                      "VIEW_SETTING_USER_PROFILE_PAGE"?<option value="b2b">B2B</option>:""}
              </select>
            </div>
              ...
              <span>
                ...
                <span className="upload-form-control">
                  <input
                    ...
                    accept=".xlsx"
                    type={`${
                      PermissionData()?.ALLOW_B2C_UPLOAD_TARIFF_ACTION ==
                      "ALLOW_B2C_UPLOAD_TARIFF_ACTION"
                        ? "file"
                        : "text"
                    }`}
                    onChange={(e) =>
              ...
              <span>
                ...
                <span className="upload-form-control">
                  <input
                    ...
                    accept=".xlsx"
                    type={`${
                      PermissionData()?.ALLOW_B2C_UPLOAD_INSURANCE_ACTION ==
                      "ALLOW_B2C_UPLOAD_INSURANCE_ACTION"
                        ? "file"
                        : "text"
                    }`}
                    onChange={(e) =>
              ...
              <span>
                ...
                <span className="upload-form-control">
                  <input
                    ...
                    accept=".xlsx"
                    type={`${
                      PermissionData()?.ALLOW_B2C_UPLOAD_PACKAGING_ACTION ==
                      "ALLOW_B2C_UPLOAD_PACKAGING_ACTION"
                        ? "file"
                        : "text"
                    }`}
                    onChange={(e) =>
            ...
            <ul className="userprofile-list">
              {PermissionData()?.VIEW_B2C_USER_PROFILE ==
              "VIEW_B2C_USER_PROFILE"
                        ...
                        <div className="part">
                          ...
                          <div className="user-btn">
                            <button
                              ...
                              className={`me-2 
                          ${
                            PermissionData()?.DELETE_B2C_USER_PROFILE ==
                            "DELETE_B2C_USER_PROFILE"
                              ? " "
                              : "permission_blur"
                          }`}
                              onClick={(e) =>

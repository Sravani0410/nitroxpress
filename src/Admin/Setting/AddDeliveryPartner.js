...
import {
  ...
  PatchAdminSettingDeliveryPartner,
...
const AddDeliveryPartner = () => {
  ...
  const PatchAdminSettingDeliveryPartnerData = useSelector(
    (state) =>
      state.PatchAdminSettingDeliveryPartnerReducer
  ...
  const EditSaveBtn = (e) => {
    ...
    if (partnername != null && partnername != "") {
      dispatch(PatchAdminSettingDeliveryPartner(payload));
      SetEditUser(false);
    } else {
      toast.warn("Please Enter Partner Name");
    }
        ...
        <div className="content-sec settings-sec">
          <div className="ordertittle-part">
            ...
            <div className="btngroup">
              ...
              {PermissionData()?.CREATE_DELIVERY_PARTNER ==
          ...
          <div className="employe-table">
            <table>
              <tr>
                {/* <th>DeliveryPartner_id</th> */}
                <th>Partner Name</th>
                <th>POC</th>
                <th>Action</th>
              </tr>
              {PermissionData()?.VIEW_DELIVERY_PARTNER ==
              "VIEW_DELIVERY_PARTNER"
                ? GetAdminSettingDeliveryPartnerData?.data &&
                  GetAdminSettingDeliveryPartnerData?.data?.map((item, id) => {
                    return (
                      <tr>
                        {/* <td>{item.id}</td> */}
                          ...
                          <div className="action-btngroup">
                            <button
                              ...
                              className={`btn svg-btn  ${
                                PermissionData()?.DELETE_DELIVERY_PARTNER ==
                            ...
                            <button
                              ...
                              className={`btn svg-btn 
                            ${
                              PermissionData()?.EDIT_DELIVERY_PARTNER ==
                              "EDIT_DELIVERY_PARTNER"
                                ? " "
                                : "permission_blur"
                            }`}
                              onClick={(e) =>

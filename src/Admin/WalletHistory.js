          ...
          <div className="wallet-part">
            <div className="left-part">
              ...
              <h4>
                ...
                </svg><span> {GetWalletBalanceData?.data?.current_balance_status=="NEGATIVE"?`Rs. -${GetWalletBalanceData?.data?.current_balance}`:`Rs. ${GetWalletBalanceData?.data?.current_balance}`}/-</span>
              </h4>

                      ...
                      return (
                        <li>
                          ...
                          <div className="row mx-0">
                            ...
                            <div
                              className={`${
                                item?.transaction_status == "COMPLETED"
                                  ? " text-green  col-4 pb-3 text-end"
                                  : "text-yellow  col-4 pb-3 text-end"
                              }  ${
                                item?.status == "DEBIT"
                                  ? " text-red   col-4 pb-3 text-end"
                                  : ""
                              }    ${
                            ...
                            <div className="col-6">{item.created_time}</div>
                ...
                <div className="editb2b-box">
                  ...
                  <div className="popup-body row">
                    ...
                    {/* <div className="col-sm-6">
                      <div className="mt-4">
                        <label className="mt-4 fw-bold">Amount</label>
                        <input
                          type="number"
                          className="form-control"
                          placeholder="Rs. /-"
                      ...
                      <div className="mt-4">
                        <label className="fw-bold">Upload ScreenShot</label>
                        <input
                          type="file"
                          className="form-control"
                          accept="image/*"

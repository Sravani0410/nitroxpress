...
import {
  ...
  PostDashboardRevenue, PostOrderTrack
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    setRtoDelivered(
      GetAdminDashboardViewOrderData &&
        GetAdminDashboardViewOrderData[0]?.rto_delivered_order
    );
    setRto(
      GetAdminDashboardViewOrderData &&
        GetAdminDashboardViewOrderData[0]?.rto_order
    );
  ...
  useEffect(() => {
    ...
    setTrackActive(true);
    if (
      PostOrderTrackData.status == 200 &&
      param?.pathname == "/admin/dashboard" &&
      OrderId1 == true
    ) {
          ...
          <div className="content-sec">
            <div className="dashboardcontent-title">
              ...
              <div className="d-flex">
                <div className="ordertittle-part p-0">
                  ...
                  {PermissionData()?.VIEW_ORDER_TRACK_PAGE == "VIEW_ORDER_TRACK_PAGE"?<button
                    type="button"
                    className={`${trackActive ? "track-btn" : ""} ${
                      PermissionData()?.VIEW_TRACK_SEARCH_DASHBOARD ==
                      "VIEW_TRACK_SEARCH_DASHBOARD"
                        ? ""
                        : "permission_blur"
                ...
                <div className={`filter-part  `}>
                  <button
                    ...
                    className={`${filterActive ? "bg-warning btn" : " btn"}  ${
                      PermissionData()?.APPLY_DASHBOARD_FILTER ==
                  ...
                  >
                    ...
                    {/* <div className="search-box">
                      <input type='' minLength={10} className='form-control' placeholder='Search' onChange={(e) => SearchPage(e)} />
                      <span>
                    ...
                    {isAdmin_Role == "true" || isEmploye_Role == "true" ? (
                    ...
                    {isAdmin_Role == "true" || isEmploye_Role == "true" ? (
                      <div className="express-box">
                        <select
                          ...
                          onChange={(e) =>
                            setB2BPartnerSelectedValue(e.target.value)
                          }
                        >
            ...
            <div className="dashboardcontent-part">
              <ul className="adminorder-list">
                <li
                  className={`${
                    PermissionData()?.VIEW_DASHBOARD_TOTAL_ORDER ==
                    "VIEW_DASHBOARD_TOTAL_ORDER"
                      ? " "
                      : "permission_blur"
                  }`}
                >
                ...
                <li
                  className={`${
                    PermissionData()?.VIEW_DASHBOARD_PENDING ==
                    "VIEW_DASHBOARD_PENDING"
                      ? " "
                      : "permission_blur"
                  }`}
                >
                ...
                <li
                  className={`${
                    PermissionData()?.VIEW_DASHBOARD_DELIVERED ==
                    "VIEW_DASHBOARD_DELIVERED"
                      ? " "
                      : "permission_blur"
                  }`}
                >
              ...
              <div className="meter-box textprevent">
                <div
                  className={`admin-box   ${
                    PermissionData()?.VIEW_DASHBOARD_SHIPMENT_MATRIX ==
                    "VIEW_DASHBOARD_SHIPMENT_MATRIX"
                      ? " "
                      : "permission_blur"
                  }`}
                >
                ...
                <div
                  className={`admin-box ${
                    PermissionData()?.VIEW_ACTIVE_SHIPMENT ==
                    "VIEW_ACTIVE_SHIPMENT"
                      ? " "
                      : "permission_blur"
                  }`}
                >
                  ...
                  <div className="p-3">
                    ...
                    {rto != undefined &&
                      ...
                      issues != undefined &&
                      rtodelivered != undefined && (
                        <Chart
                          type="donut"
                          width="100%"
                          height="100%"
                          // series={[pendingorder, issues,rto, deliveredorder, rtodelivered ]}
                          // series={[0, 0, 0, 0,0]}
                          series={
                            PermissionData()?.VIEW_ACTIVE_SHIPMENT ==
                            "VIEW_ACTIVE_SHIPMENT"
                    ...
                    <div className="row">
                      ...
                      <div className="col-4 mb-3">
                        <label className="circle-checkbox rto-box">
                          RTO (
                          {PermissionData()?.VIEW_ACTIVE_SHIPMENT ==
                          "VIEW_ACTIVE_SHIPMENT"
                            ? rto
                      ...
                      <div className="col-8 mb-3">
                        <label className="circle-checkbox rto-delivered-box">
                          RTO Delivered (
                          {PermissionData()?.VIEW_ACTIVE_SHIPMENT ==
                          "VIEW_ACTIVE_SHIPMENT"
                            ? rtodelivered
              ...
              <div className="rev-box">
                <div
                  className={`admin-box transaction-box mt-3 ${
                    PermissionData()?.VIEW_DASHBOARD_TRANSACTION ==
                    "VIEW_DASHBOARD_TRANSACTION"
                      ? " "
                      : "permission_blur"
                  }`}
                >
                  ...
                  <div className="transaction-table ">
                    <table>
                      ...
                      <tbody>
                        ...
                        "VIEW_DASHBOARD_TRANSACTION"
                          ? PostAdminDashboardTransactionData &&
                            PostAdminDashboardTransactionData?.transaction_details?.map(
                              (item, id) => {
                                return (
                                  <tr>
                                    <td>
                ...
                <div
                  className={`admin-box mt-3 transaction-box mt-3 ${
                    PermissionData()?.VIEW_DASHBOARD_REVENUE ==
        ...
        <div className="wallet-popup d-none">
          <div className="popupinner">
            ...
            <div className="popup-body">
              ...
              <button type="button" className="btn pr-onl">
                Proceed Online{" "}
              </button>
            </div>
          </div>
        ...
        <div className="wallet-popup  d-none">
          <div className="popupinner">
            ...
            <div className="popup-body">
              ...
              <button type="button" className="btn pr-pay mb-0">
                Continue
              </button>
            </div>
          </div>
